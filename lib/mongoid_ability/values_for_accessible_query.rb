...
#       @owner_id_locks_for_subject_type[cls.to_s] ||= owner.locks_relation.id_locks.for_action(action).for_subject_type(cls.to_s).cache
#     end
#
...
#       @inherited_from_relation_ids_locks_for_subject_type[cls.to_s] ||= inherited_from_relation.collect do |o|
